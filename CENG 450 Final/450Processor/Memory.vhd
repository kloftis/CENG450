...
ARCHITECTURE CFG OF Memory IS
	...
	--	below, are in decimal, whereas the data supplied is in hexadecimal
		...
		24	=>	x"00", 
		25	=>	x"4A", 
		26	=>	x"9E",	-- Goto subroutine
		27	=>	x"C4",	-- Output R1 (should be 48; if it's -2 then SUB failed)
		28	=>	x"00", 
		29	=>	x"00",
		
		-- Jump to 60
		30	=>	x"3C",	-- LOADIMM R3 60
		31	=>	x"3C",
		32 => x"93",	-- GOTO R3
		...
		62 => x"10",
		63 => x"07",
		64 => x"C0",	-- Output R0 (should be 48)
		
		65 => x"30",	-- Reset registers to all initial values (except without using input port)
		66 => x"01",
		67 => x"34",
		68 => x"FC",
		69 => x"38",
		...
		-- Go back to start of program (well, instr 4)
		71 => x"3C",	-- LOADIMM R3 4
		72 => x"04",
		73 => x"93",	-- GOTO R3
