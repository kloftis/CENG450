...
BEGIN SCHEMATIC
    ...
    BEGIN NETLIST
        ...
        BEGIN BLOCK XLXI_7 MEM_WB_Buffer
            ...
            PIN wb_data_out(7:0) XLXN_40(7:0)
            PIN clk CLK
        ...
        BEGIN BLOCK XLXI_8 EX_MEM_Buffer
            ...
            PIN result_in(7:0) XLXN_101(7:0)
        ...
        BEGIN BLOCK XLXI_9 ALU
            PIN clk CLK
            PIN rst RST
            PIN in1(7:0) XLXN_98(7:0)
            PIN in2(7:0) XLXN_99(7:0)
            PIN alu_mode(2:0) XLXN_97(2:0)
            PIN z_flag
            PIN n_flag
            PIN result(7:0) XLXN_101(7:0)
        END BLOCK
        ...
        BEGIN BLOCK XLXI_10 ID_EX_Buffer
            PIN mem_op XLXN_27
            PIN wb_op XLXN_100
            PIN data1_out(7:0) XLXN_98(7:0)
            PIN data2_out(7:0) XLXN_99(7:0)
            PIN clk CLK
            ...
            PIN alu_mode_out(2:0) XLXN_97(2:0)
        END BLOCK
    ...
    BEGIN SHEET 1 5440 3520
        ...
        END BRANCH
        BEGIN BRANCH XLXN_97(2:0)
            WIRE 2672 1440 2880 1440
        END BRANCH
        BEGIN BRANCH XLXN_98(7:0)
            WIRE 2672 1312 2880 1312
        END BRANCH
        BEGIN BRANCH XLXN_99(7:0)
            WIRE 2672 1376 2880 1376
        END BRANCH
